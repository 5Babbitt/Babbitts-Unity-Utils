...
namespace BabbittsUnityUtils
{
    public static class InputUtils
    {
        ...
        public static void RegisterInputPhases(InputAction action, Action<InputAction.CallbackContext> callback, InputPhases inputPhases = InputPhases.All)
        {
        ...
        public static void UnregisterInputPhases(InputAction action, Action<InputAction.CallbackContext> callback, InputPhases inputPhases = InputPhases.All)
        {
            if (inputPhases.HasFlag(InputPhases.Started))
                action.started -= callback;
            if (inputPhases.HasFlag(InputPhases.Performed))
